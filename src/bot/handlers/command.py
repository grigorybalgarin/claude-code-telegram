...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_message = (
        ...
        f"📁 Mention a project name when needed and I will route the request automatically.\n\n"
        ...
        f"<b>Quick Start:</b>\n"
        f"1. Send a natural-language task, for example <code>почини тесты в ClaudeBot</code>\n"
        f"2. Use <code>/projects</code> only when you want to browse projects manually\n"
        f"3. Use <code>/cd &lt;project&gt;</code> only when you want to pin a workspace yourself\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = (
        ...
        "The bot now auto-detects the workspace from your request, creates checkpoints before risky edits, "
